...
def home_page(request):
    ...
    x = cart_count.count()
    return render(request, 'Home.html', {'categ': categ, 'x': x, 'prod': prod})
...
def cart_page(request):
    ...
    return render(request, 'Cart.html',
                  {'categ': categ, 'crt': crt, 'sub_total': sub_total, 'ship_charge': ship_charge, 'total': total,
                   'x': x})
